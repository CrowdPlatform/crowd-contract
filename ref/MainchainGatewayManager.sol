...
abstract contract IValidator {
  ...
  function isValidator(address _addr) virtual public view returns (bool);
  function getValidators() virtual public view returns (address[] memory _validators);

  function checkThreshold(uint256 _voteCount) virtual public view returns (bool);
}
